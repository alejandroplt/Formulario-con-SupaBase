document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('[data-bs-target="#myModal"]').forEach(button => {
        button.addEventListener('click', function () {
            ...
            if (formSubmitted) {
                ...
                document.getElementById('privacyCheck').checked = true; // Checkbox activo
                document.getElementById('submit').disabled = false; // Botón habilitado
            } else {
        ...
        // Comprobar el estado del checkbox periódicamente
        setInterval(() => {
        ...
        document.getElementById('privacyCheck').addEventListener('change', function () {
            ...
            const submitButton = document.getElementById('submit');
            submitButton.disabled = !this.checked; // Activa el botón solo si el checkbox está marcado
        });
    ...
    // Crear un script externo dinámicamente para Supabase
                ...
                document.getElementById('myForm').addEventListener('submit', async function (event) {
                    ...
                    try {
                        ...
                        if (fetchError) {
                            ...
                            link.href = `https://www.oaxaca.gob.mx/medioambiente/wp-content/uploads/sites/59/2024/08/${fileId}.pdf`; // Ajusta esta ruta según la ubicación real de tus archivos PDF
